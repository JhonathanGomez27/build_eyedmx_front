...
class AdminService {
  ...
  // Cambiar metodo pago
  //-----------------------------------
  cambiarMetodoPago(pulsera) {
    const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders();
    headers.set('Authorization', '');
    return this._httpClient.patch(`${this.url}pagos/cambiarEstadoOMetodo/${pulsera}`, {
      estado: 'wait',
      metodo: 'Efectivo'
    });
  }
...
//# sourceMappingURL=default-src_app_admin_admin_service_ts.05a878d9a6797585.js.map